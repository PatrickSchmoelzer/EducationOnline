...
<body>
	...
	<!--- End Section Border -->
    <div class="clear"></div>
    <!--- Start Banner Wrapper - Materials 1 -->
		<div id="banner-wrapper">
			<h1>Verfügbare Materialien</h1>
			<section class="one-quarter">
				<i class="fa fa-pencil fa-4x fa-border materials icon english"></i>
				<h3>Englisch</h3>
				<p>
					Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. At vero eos et accusam et justo duo dolores et ea rebum. Stet clita kasd gubergren, no sea takimata 
                    sanctus est 
			...
			<section class="one-quarter">
				<i class="fa fa-pencil fa-4x fa-border materials icon informatics"></i>
				<h3>Informatik</h3>
				<p>
					Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. At vero eos et accusam et justo duo dolores et ea rebum. Stet clita kasd gubergren, no sea takimata 
                    sanctus est 
			...
			<section class="one-quarter">
				<i class="fa fa-pencil fa-4x fa-border materials icon philosophy"></i>
				<h3>Philosophie</h3>
				<p>
					Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. At vero eos et accusam et justo duo dolores et ea rebum. Stet clita kasd gubergren, no sea takimata 
                    sanctus est 
            ...
            <section class="one-quarter">
				<i class="fa fa-pencil fa-4x fa-border materials icon math"></i>
				<h3>Mathematik</h3>
				<p>
					Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. At vero eos et accusam et justo duo dolores et ea rebum. Stet clita kasd gubergren, no sea takimata 
                    sanctus est 
	...
	<!--- End Banner Wrapper - Materials 1 -->
    <div class="clear"></div>
    <!--- Start Banner Wrapper - Materials 2 -->
		<div id="banner-wrapper">			
			<section class="one-quarter">
				<i class="fa fa-pencil fa-4x fa-border materials icon german"></i>
				<h3>Deutsch</h3>
				<p>
					Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. At vero eos et accusam et justo duo dolores et ea rebum. Stet clita kasd gubergren, no sea takimata 
                    sanctus est 
			...
			<section class="one-quarter">
				<i class="fa fa-pencil fa-4x fa-border materials icon chemics"></i>
				<h3>Chemie</h3>
				<p>
					Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. At vero eos et accusam et justo duo dolores et ea rebum. Stet clita kasd gubergren, no sea takimata 
                    sanctus est 
			...
			<section class="one-quarter">
				<i class="fa fa-pencil fa-4x fa-border materials icon history"></i>
				<h3>Geschichte</h3>
				<p>
					Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. At vero eos et accusam et justo duo dolores et ea rebum. Stet clita kasd gubergren, no sea takimata 
                    sanctus est 
            ...
            <section class="one-quarter">
				<i class="fa fa-pencil fa-4x fa-border materials icon physics"></i>
				<h3>Physik</h3>
				<p>
					Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. At vero eos et accusam et justo duo dolores et ea rebum. Stet clita kasd gubergren, no sea takimata 
                    sanctus est 
	...
	<!--- End Banner Wrapper - Materials 2 -->	
	<div class="clear"></div>
	<!--- Start Footer -->
	<?php
